...
async def seed_database():
    ...
    try:
        ...
        await conn.execute(
            "TRUNCATE TABLE encuesta_paciente_json, encuesta_sesion_json, "
        ...
        pacientes_data = [
            (
                ...
                62,
                "Avenida 2 Sur 1456, Talca, Región del Maule",
            ...
            (
                ...
                45,
                "Calle Estado 235, Curicó, Región del Maule",
                "Ninguno",
                "HER2 positivo",
                date(2025, 9, 15),
            ),
            (
                ...
                58,
                "Pasaje Los Robles 123, Talca, Región del Maule",
                "Hipertensión",
                "Requiere control de dolor",
                date(2025, 9, 20),
            ),
            (
                "14.567.890-1",
                "Carmen Silva Rojas",
                "carmen.silva@example.com",
                52,
                "Avenida Lircay 456, Talca, Región del Maule",
                "Diabetes tipo 2",
                "Linfoma en tratamiento",
                date(2025, 9, 25),
            ),
        ]
        ...
        sesion1 = await conn.fetchrow(
            ...
            RETURNING id_sesion
        """,
            pacientes[0]["id_paciente"],
            id_patologia,
            tratamientos[0]["id_tratamiento"],
            sillones[0]["id_sillon"],
            encargados[1]["id_encargado"],
            date(2025, 10, 10),
            time(9, 0),
            time(11, 40),
            15,
            "Guantes, Jeringas, Vías periféricas",
            "confirmado",
        )
        ...
        sesion2 = await conn.fetchrow(
            ...
            RETURNING id_sesion
        """,
            pacientes[1]["id_paciente"],
            id_patologia,
            tratamientos[1]["id_tratamiento"],
            sillones[1]["id_sillon"],
            encargados[2]["id_encargado"],
            date(2025, 10, 10),
            time(9, 15),
            time(13, 25),
            15,
            "Guantes, Catéter central, Soluciones",
            "confirmado",
        )
        ...
        """,
            pacientes[0]["id_paciente"],
            condiciones[0]["id_condicion"],
            date(2015, 3, 10),
            condiciones[1]["id_condicion"],
            date(2018, 7, 20),
        )
        ...
        """,
            medicos[0]["id_medico"],
            especializaciones[0]["id_especializacion"],
            medicos[1]["id_medico"],
            especializaciones[2]["id_especializacion"],
        )
        print(
            f"   📌 {len(consulta_prof)} vinculaciones médico-especialización creadas"
        )
        ...
        await conn.execute(
            ...
            VALUES ($1, $2), ($3, $4)
        """,
            cie10_list[0]["id_cie10"],
            ges_list[0]["id_ges"],
            cie10_list[1]["id_cie10"],
            ges_list[1]["id_ges"],
        )
        ...
        """,
            ...
            tipos_examen[0]["id_tipo_examen"],
            consulta_prof[0]["id_profesional"],
            instalaciones[0]["id_instalacion"],
            estados[2]["id_estado"],
            date(2025, 10, 6),
        )
        ...
        """,
            orden_hosp["id_orden_hospitalizacion"],
            pacientes[1]["id_paciente"],
            consulta_prof[0]["id_profesional"],
            date(2025, 10, 15),
            date(2025, 10, 20),
